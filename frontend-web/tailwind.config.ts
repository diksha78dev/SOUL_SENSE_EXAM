...
const config: Config = {
  ...
  theme: {
    extend: {
       ...
       * ======================================== */
      boxShadow: {
        primary: '0 8px 30px rgba(var(--primary), 0.25)',
        secondary: '0 8px 30px rgba(var(--secondary), 0.2)',
        success: '0 8px 30px rgba(16, 185, 129, 0.2)',
        warning: '0 8px 30px rgba(245, 158, 11, 0.2)',
        destructive: '0 8px 30px rgba(239, 68, 68, 0.2)',
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(135deg, hsl(240, 10%, 4%) 0%, hsl(240, 5%, 15%) 100%)',
        'gradient-light': 'linear-gradient(135deg, hsl(0, 0%, 100%) 0%, hsl(240, 5%, 96%) 100%)',
