...
export type InsightType = 'tip' | 'pattern' | 'goal' | 'alert' | 'safety' | 'trend';
...
export const InsightCard = ({ insight, onDismiss, onAction, className }: InsightCardProps) => {
  const config = typeConfigs[insight.type] || typeConfigs.tip;
